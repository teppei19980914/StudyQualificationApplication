...
class DashboardLayoutService:
    ...
    WIDGET_REGISTRY: ClassVar[dict[str, WidgetMetadata]] = {
        ...
        "weekly_comparison": WidgetMetadata(
            widget_type="weekly_comparison",
            display_name="\u9031\u9593\u6bd4\u8f03",
            icon="\U0001f4ca",
            default_span=1,
            allowed_spans=[1, 2],
        ),
        "milestone": WidgetMetadata(
            widget_type="milestone",
            display_name="\u30de\u30a4\u30eb\u30b9\u30c8\u30fc\u30f3",
            icon="\U0001f3c6",
            default_span=1,
            allowed_spans=[1, 2],
        ),
    ...
    def get_default_layout(self) -> list[DashboardWidgetConfig]:
        ...
        return [
            ...
            DashboardWidgetConfig("weekly_comparison", 1),
            DashboardWidgetConfig("milestone", 1),
